...
const vehicle_specs_module_1 = require("../vehicle-specs/vehicle-specs.module");
...
exports.VehiclesModule = VehiclesModule = __decorate([
    (0, common_1.Module)({
        imports: [vehicle_specs_module_1.VehicleSpecsModule],
        controllers: [vehicles_controller_1.VehiclesController],
        providers: [vehicles_service_1.VehiclesService, stock_service_1.StockService],
        exports: [vehicles_service_1.VehiclesService, stock_service_1.StockService],
    })
], VehiclesModule);
