...
exports.default = () => ({
    ...
    jwt: {
        ...
        passwordResetExpiresMin: parseInt(process.env.PASSWORD_RESET_EXPIRES_MIN || '30', 10),
    },
    security: {
    ...
    business: {
        ...
        leadAssignmentStrategy: process.env.LEAD_ASSIGNMENT_STRATEGY || 'round_robin',
        docExpiryAlertDays: parseInt(process.env.DOC_EXPIRY_ALERT_DAYS || '30', 10),
        reservationDefaultDays: parseInt(process.env.RESERVATION_DEFAULT_DAYS || '3', 10),
